...
def simulate_custom_input(show_plot=True):
    ...
    vr_input   = vrs['In1']      
    vr_out1 = vrs['Out1[1]']  # angular velocity of the 4th inertia
    ...
    while time < stop_time:
        ...
        # set the input
        fmu.setReal([vr_input], [0.0 if time < 0.9 else 1.0])
        ...
        inputs, outputs4 = fmu.getReal([vr_input, vr_out1])
