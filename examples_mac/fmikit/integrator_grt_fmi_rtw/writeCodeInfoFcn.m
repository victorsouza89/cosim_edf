% Autogenerated file: Wed Mar  1 14:04:15 2023
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("integrator",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'integrator.h';
    func_Initialize_Prototype.SourceFile = 'integrator.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'integrator_initialize';
    ...
    func_UpdateContStates_Prototype.Return     = tmpRet;
        ...
        func_UpdateContStates_Prototype.HeaderFile = 'integrator.h';
    func_UpdateContStates_Prototype.SourceFile = 'integrator.c';
    ...
    time_1 = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, 1));
        func_UpdateContStates_Interface.Timing = time_1;
            func_UpdateContStates_Prototype.Name = 'integrator_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'integrator.h';
    func_Terminate_Prototype.SourceFile = 'integrator.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['integrator_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_integrator_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'integrator_M_');
        Var_RTModel.Owner           = 'integrator';
        Var_RTModel.DeclarationFile = 'integrator.h';
            Var_RTModel.DefinitionFile  = 'integrator.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'integrator_M', Var_RTModel);
